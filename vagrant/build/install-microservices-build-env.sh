...
then
  ...
  echo "Installing iRODS Sudo microservices build environment on AlmaLinux."
...
then
  ...
  echo "Installing iRODS Sudo microservices build environment on Ubuntu."
...
git clone https://github.com/UtrechtUniversity/irods-sudo-microservices.git
mkdir irods-sudo-microservices/build
chown -R vagrant:vagrant irods-sudo-microservices
